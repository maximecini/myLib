...
/*   Updated: 2024/11/29 19:40:00 by rcini-ha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * @param c Le caractère à vérifier, passé sous forme d'entier (comme spécifié par les standards C).
 *
 * @return 
 ...
 *       Les lettres majuscules, les chiffres, les caractères spéciaux ou tout autre
