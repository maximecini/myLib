...
#    Updated: 2024/12/14 13:26:20 by rcini-ha         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_lstadd_back.c ft_lstdelone.c ft_lstclear.c ft_lstiter.c ft_lstmap.c ft_digitlen.c ft_islowercase.c\
ft_base_power.c ft_istouppercase.c get_next_line.c get_next_line_utils.c ft_putnbr_base.c valide_base.c \
ft_printf.c ft_calculate_length.c ft_todigits.c ft_int_isdigit.c
