...
/*   Updated: 2024/11/29 21:06:52 by rcini-ha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Recherche la première occurrence d'une sous-chaîne dans une chaîne
 *  principale, avec une limite.
 *
 * La fonction `ft_strnstr` recherche la première occurrence de 
 * la sous-chaîne `needle` dans la chaîne principale `haystack`, en ne 
 * parcourant que les `len` premiers caractères de `haystack`. Si `needle` est 
 * une chaîne vide, la fonction retourne immédiatement `haystack`. Si `needle`
 * est trouvé dans `haystack` dans la limite spécifiée, la fonction retourne 
